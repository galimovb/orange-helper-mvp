...
// ../../node_modules/.pnpm/tsup@8.5.0_jiti@1.21.7_postcss@8.5.6_tsx@4.19.4_typescript@5.8.3_yaml@2.7.0/node_modules/tsup/assets/cjs_shims.js
  ...
  return {
    ...
    config(userConfig, { mode }) {
      ...
      const extraConfig = {
        ...
        server: {
          watch: {
            ignored: userConfig.server?.watch?.ignored ? userConfig.server.watch.ignored : ["**/vendor/**", import_fast_glob.default.escapePath(root + "/var") + "/**", import_fast_glob.default.escapePath(root + "/public") + "/**"]
          }
        }
      };
      return extraConfig;
  ...
  return {
    ...
    transform(code, id, options) {
      ...
      if (viteCommand === "serve" && pluginOptions.hmr) {
        ...
        const isInsideControllerDir = isPathIncluded((0, import_node_path6.join)(viteConfig.root, pluginOptions.controllersDir), id);
