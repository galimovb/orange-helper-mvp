 ...
 */
final class Version20250629074052 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE user ADD COLUMN children_full_name VARCHAR(255) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user ADD COLUMN children_age INTEGER DEFAULT NULL
        SQL);
    }
