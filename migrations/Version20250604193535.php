 ...
 */
final class Version20250604193535 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, login, first_name, last_name, second_name, created_at, roles, updated_at, is_active, age FROM user
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE user
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO user (id, email, login, first_name, last_name, second_name, created_at, roles, updated_at, is_active, age) SELECT id, email, login, first_name, last_name, second_name, created_at, roles, updated_at, is_active, age FROM __temp__user
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ...
            , roles CLOB NOT NULL --(DC2Type:array)
            , updated_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
            , is_active BOOLEAN DEFAULT NULL, age INTEGER NOT NULL)
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO "user" (id, email, login, first_name, last_name, second_name, created_at, roles, updated_at, is_active, age) SELECT id, email, login, first_name, last_name, second_name, created_at, roles, updated_at, is_active, age FROM __temp__user
        SQL);
